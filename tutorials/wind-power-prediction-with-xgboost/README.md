...
```
                  ...
                  │  ensure_pull_secret (@task)                 │
                  │                                             │
  OpenBao  ──────▶│  1) urllib 로 secret/wind-power 조회        │
  KV v2          │     (gitea_username, gitea_password)         │
                  │                                             │
...
| `ensure_pull_secret` 태스크 실패 | [imagePullSecret 자동 관리 § 트러블슈팅](#트러블슈팅) 참조 |
